...
add.onclick = function () {
    ...
    if (name != '' && email != '' && pNumber != '' && age != '' && addr != '') {
        ...
        if (document.querySelector('input[type="radio"]:checked').value == 'Male') {
            img.src="https://cdn5.vectorstock.com/i/1000x1000/40/54/person-gray-photo-placeholder-man-vector-25134054.jpg";
            img.setAttribute('alt', 'Male')
        }
        
        else {
            img.src="https://cdn1.vectorstock.com/i/1000x1000/98/20/person-gray-photo-placeholder-woman-vector-23519820.jpg";
